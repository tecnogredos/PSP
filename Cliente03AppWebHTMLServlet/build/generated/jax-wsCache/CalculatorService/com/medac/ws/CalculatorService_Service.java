 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://ws.medac.com/", wsdlLocation = "http://localhost:8080/CalculadoraWS/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://ws.medac.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculadoraWS/CalculatorService?wsdl");
    ...
    public CalculatorService getCalculatorServicePort() {
        return super.getPort(new QName("http://ws.medac.com/", "CalculatorServicePort"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.medac.com/", "CalculatorServicePort"), CalculatorService.class, features);
    }
