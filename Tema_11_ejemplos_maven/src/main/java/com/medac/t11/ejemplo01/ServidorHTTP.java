...
/**
 * Ejemplo visto en el tema 8.
 * Nos conectamos con un cliente ligero
 * @author 
 */
public class ServidorHTTP {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println(ServidorHTTP.class.getName() + ex.getMessage());
        }
    }
    /**
    ...
    private static void gestionar(HttpExchange exchange) {
        try {
            ...
            String response_msg = "<h1>Otra cosa</h1><h1>Hola mundo desde el servidor</h1><p>Hola esto es una prueba</p>";
